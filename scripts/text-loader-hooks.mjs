/**
 * The loader hooks themselves. Node's `register()` must load its hooks from a
 * separate module — it evaluates them on a dedicated thread — so this file holds
 * the hooks and text-loader.mjs holds the registration; neither works alone.
 *
