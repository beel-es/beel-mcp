        ...
        messages: [
          userMessage(
            [
              ...
              '7. Issue a first TEST invoice with `beel_create_invoice` (test key beel_sk_test_)',
              '   to confirm the pipeline end to end.',
              '8. Go Live: re-run `beel_get_issuing_readiness` until `ready` is true, then switch',
